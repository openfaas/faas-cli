...
func Test_preRunSecretUpdateCmd_NoArgs_Fails(t *testing.T) {
	res := preRunSecretUpdateCmd(nil, []string{})
...
func Test_preRunSecretUpdateCmd_MoreThan1Arg_Fails(t *testing.T) {
	res := preRunSecretUpdateCmd(nil, []string{
		"secret1",
		"secret2",
	})
...
func Test_preRunSecretUpdateCmd_ExtactlyOneArgIsFine(t *testing.T) {
	res := preRunSecretUpdateCmd(nil, []string{
		"secret1",
	})
